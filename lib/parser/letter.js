  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "indexed_nonterm_symbol": parse_indexed_nonterm_symbol,
        "rule": parse_rule,
        ...
        "basic_or_array_param_id": parse_basic_or_array_param_id,
        "offset_array_param_id": parse_offset_array_param_id,
      ...
      function parse_indexed_nonterm_symbol() {
        var result0, result1;
        var pos0, pos1;
      ...
      function parse_hint_with_modifiers() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, weight, hint_text, mods) { return [weight, hint_text, mods.reduce(LetterWriter.extend,{})] })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, weight, mods) { return [weight, undefined, mods.reduce(LetterWriter.extend,{})] })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, hint_text, mods) { return [null, hint_text, mods.reduce(LetterWriter.extend,{})] })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_sym_expr() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            pos0 = clone(pos);
            result0 = parse_indexed_nonterm_symbol();
            if (result0 !== null) {
              result0 = (function(offset, line, column, sym) { return makeIndexedNontermReference(sym) })(pos0.offset, pos0.line, pos0.column, result0);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_preamble_placeholder_prompt() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, preamble, placeholder, prompt, postamble) { return {preamble:preamble, placeholder:placeholder, prompt:prompt, postamble:postamble}; })(pos0.offset, pos0.line, pos0.column, result0[1], result0[3], result0[5], result0[7]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_bare_param_id() {
        ...
        result0 = parse_basic_or_array_param_id();
        if (result0 === null) {
          result0 = parse_offset_array_param_id();
        }
        return result0;
      }
      
      function parse_basic_or_array_param_id() {
        var result0, result1, result2, result3, result4, result5, result6;
        var pos0, pos1;
      ...
      function parse_offset_array_param_id() {
        var result0, result1;
        var pos0, pos1;
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 === null) {
                      ...
                      if (result3 !== null) {
                        ...
                        if (result4 !== null) {
                          ...
                          if (result5 !== null) {
                            ...
                            if (result6 !== null) {
                              result7 = [];
                              result8 = parse_linespc();
                              while (result8 !== null) {
                                result7.push(result8);
                                result8 = parse_linespc();
                              }
                              if (result7 !== null) {
                                result8 = parse_param_expr();
                                if (result8 !== null) {
                                  result9 = [];
                                  result10 = parse_linespc();
                                  while (result10 !== null) {
                                    result9.push(result10);
                                    result10 = parse_linespc();
                                  }
                                  if (result9 !== null) {
                                    ...
                                    if (result10 !== null) {
                                      result11 = [];
                                      result12 = parse_linespc();
                                      while (result12 !== null) {
                                        result11.push(result12);
                                        result12 = parse_linespc();
                                      }
                                      if (result11 !== null) {
                                        result12 = parse_param_expr();
                                        if (result12 !== null) {
                                          result13 = [];
                                          result14 = parse_linespc();
                                          while (result14 !== null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, line, column, cond, t, f) { return new LetterWriter.ParamFunc ({op:"?",cond:cond,t:t,f:f}) })(pos0.offset, pos0.line, pos0.column, result0[4], result0[8], result0[12]);
                }
                if (result0 === null) {
                  pos = clone(pos0);
                }
                if (result0 === null) {
                  pos0 = clone(pos);
                  pos1 = clone(pos);
                  if (input.substr(pos.offset, 4) === "&cat") {
                    result0 = "&cat";
                    advance(pos, 4);
                  } else {
                    result0 = null;
                  ...
                  if (result0 !== null) {
                    result0 = (function(offset, line, column, l, r) { return new LetterWriter.ParamFunc ({op:".",l:l,r:r}) })(pos0.offset, pos0.line, pos0.column, result0[4], result0[8]);
                  }
                  if (result0 === null) {
                    pos = clone(pos0);
                  }
                  if (result0 === null) {
                    pos0 = clone(pos);
                    pos1 = clone(pos);
                    if (input.substr(pos.offset, 4) === "&mul") {
                      result0 = "&mul";
                      advance(pos, 4);
                    } else {
                      result0 = null;
                    ...
                    if (result0 === null) {
                      pos0 = clone(pos);
                      pos1 = clone(pos);
                      if (input.substr(pos.offset, 4) === "&div") {
                        result0 = "&div";
                        advance(pos, 4);
                      } else {
                        result0 = null;
                      ...
                      if (result0 === null) {
                        pos0 = clone(pos);
                        pos1 = clone(pos);
                        if (input.substr(pos.offset, 4) === "&add") {
                          result0 = "&add";
                          advance(pos, 4);
                        } else {
                          result0 = null;
                        ...
                        if (result0 === null) {
                          pos0 = clone(pos);
                          pos1 = clone(pos);
                          if (input.substr(pos.offset, 4) === "&sub") {
                            result0 = "&sub";
                            advance(pos, 4);
                          } else {
                            result0 = null;
                          ...
                          if (result0 === null) {
                            pos0 = clone(pos);
                            pos1 = clone(pos);
                            if (input.substr(pos.offset, 4) === "&not") {
                              result0 = "&not";
                              advance(pos, 4);
                            } else {
                              result0 = null;
                            ...
                            if (result0 !== null) {
                              result0 = (function(offset, line, column, l) { return new LetterWriter.ParamFunc ({op:"!",l:l}) })(pos0.offset, pos0.line, pos0.column, result0[4]);
                            }
                            if (result0 === null) {
                              pos = clone(pos0);
                            }
                            if (result0 === null) {
                              pos0 = clone(pos);
                              pos1 = clone(pos);
                              if (input.substr(pos.offset, 3) === "&lt") {
                                result0 = "&lt";
                                advance(pos, 3);
                              } else {
                                result0 = null;
                              ...
                              if (result0 === null) {
                                pos0 = clone(pos);
                                pos1 = clone(pos);
                                if (input.substr(pos.offset, 4) === "&leq") {
                                  result0 = "&leq";
                                  advance(pos, 4);
                                } else {
                                  result0 = null;
                                ...
                                if (result0 === null) {
                                  pos0 = clone(pos);
                                  pos1 = clone(pos);
                                  if (input.substr(pos.offset, 3) === "&eq") {
                                    result0 = "&eq";
                                    advance(pos, 3);
                                  } else {
                                    result0 = null;
                                  ...
                                  if (result0 === null) {
                                    pos0 = clone(pos);
                                    pos1 = clone(pos);
                                    if (input.substr(pos.offset, 4) === "&neq") {
                                      result0 = "&neq";
                                      advance(pos, 4);
                                    } else {
                                      result0 = null;
                                    ...
                                    if (result0 === null) {
                                      pos0 = clone(pos);
                                      pos1 = clone(pos);
                                      if (input.substr(pos.offset, 4) === "&geq") {
                                        result0 = "&geq";
                                        advance(pos, 4);
                                      } else {
                                        result0 = null;
                                      ...
                                      if (result0 === null) {
                                        pos0 = clone(pos);
                                        pos1 = clone(pos);
                                        if (input.substr(pos.offset, 3) === "&gt") {
                                          result0 = "&gt";
                                          advance(pos, 3);
                                        } else {
                                          result0 = null;
                                        ...
                                        if (result0 === null) {
                                          pos0 = clone(pos);
                                          pos1 = clone(pos);
                                          if (input.substr(pos.offset, 7) === "&expand") {
                                            result0 = "&expand";
                                            advance(pos, 7);
                                          } else {
                                            result0 = null;
                                          ...
                                          if (result0 !== null) {
                                            result0 = (function(offset, line, column, l) { return new LetterWriter.ParamFunc ({op:"x",l:l}) })(pos0.offset, pos0.line, pos0.column, result0[4]);
                                          }
                                          if (result0 === null) {
                                            pos = clone(pos0);
                                          }
