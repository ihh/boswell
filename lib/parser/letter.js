  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "concat_param_expr": parse_concat_param_expr,
      ...
      function parse_concat_param_expr() {
        var result0, result1, result2, result3, result4, result5, result6, result7, result8;
        var pos0, pos1;
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        result8 = parse_concat_param_expr();
                        if (result8 !== null) {
                          result0 = [result0, result1, result2, result3, result4, result5, result6, result7, result8];
                        } else {
                          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, cond, t, f) { return new LetterWriter.ParamFunc ({op:"?",cond:cond,t:t,f:f}) })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4], result0[8]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              pos0 = clone(pos);
              pos1 = clone(pos);
              if (input.substr(pos.offset, 6) === "expand") {
                result0 = "expand";
                advance(pos, 6);
              } else {
                result0 = null;
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, l) { return new LetterWriter.ParamFunc ({l:l,op:"x"}) })(pos0.offset, pos0.line, pos0.column, result0[4]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
