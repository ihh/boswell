...
//	    console.log ("Adding moveListener[" + type + "] on " + channel)
	...
	this.preambleControl =
	    addControl ({property: "preamble",
			 ...
			 tooltip: "This is the 'entry' text. It is displayed wherever the "+wordForNonterminal+", " + nid + ", occurs in the narrative, and it goes before any other text or controllers associated with " + nid + ". It is not removed or changed after the player makes a choice, although it may be hidden in presentation."})
