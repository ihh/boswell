...
//	var editorArgs = { tooltips: false, alwaysShowParseTree: true }
	var editorArgs = {}  // TODO: get tooltips & alwaysShowParseTree from localStorage
	...
	nav.changeAlwaysShowParseTree = function() {
	    var alwaysShowParseTree
	    if ($("#alwaysShowParseTreeCheckbox")[0].checked) {
		alwaysShowParseTree = true
	    } else {
		alwaysShowParseTree = false
	    }
	    editorArgs.alwaysShowParseTree = alwaysShowParseTree
	    editor.alwaysShowParseTree = alwaysShowParseTree
	}
