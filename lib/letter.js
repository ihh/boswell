...
//		console.log("Showing " + symNode.nodeIdentifier())
	...
	var scope = this
	var divergentScope = scope.paramOwner (scope.makeParamKey (node.symbol))
...
//		span.appendChild (select);
    ...
    lw.Node.prototype.isUnexpanded = function() { return !("expansionRule" in this) }
...
//		console.log("Newly-enabled option expanded at " + this.nodeIdentifier())
	...
	return node.symbol instanceof lw.NontermReference
	    && (!("expansionRule" in node) || node.unexpandedChildren > 0)
    }
