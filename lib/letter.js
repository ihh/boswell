...
//	    console.log ("Adding moveListener[" + type + "] on " + channel)
	...
	for (var j = 0; j < rules.length; ++j) {
		...
		str += rule.weightExpr + "=>" + hint_with_modifiers + "=>"
...
//	setLocation()
	...
	for (var id in this.ruleEditor) {
		...
		.addClass(newClass)
	    this.ruleEditor[id].weightInput
		.removeClass("playerHint computerHint")
		.addClass("computerHint")
	    this.ruleEditor[id].validateHint(random)
	    this.ruleEditor[id].validateWeight()
	}
    ...
    lw.Rule.prototype.weightExpr = "1";  // for computer player
    lw.Rule.prototype.hint = "1";  // for human player
	...
	if (letter.ruleActive(this)) {
	    weight = 1
	    var expr = (this.weightExpr==null) ? this.hint : this.weightExpr
	    if (expr != "") {
...
//				 console.log(s.nodeIdentifier() + "  decrementing unexpandedChildren count of  " + p.nodeIdentifier() + "  (currently " + p.unexpandedChildren + ")")
    ...
    lw.Nonterm.prototype.addEmptyRule = function() { return this.addRule("1","",[],{}) }
...
//		span.appendChild (select);
    ...
    lw.NontermReference.prototype.substitutionSymbol = function() {
    ...
    lw.NontermParent.prototype.substitutionSymbol = function() { return this }
    ...
    lw.NontermPreamble.prototype.substitutionSymbol = function() { return this }
    ...
    lw.NontermExpansion.prototype.substitutionSymbol = function() { return this }
    ...
    lw.NontermPostamble.prototype.substitutionSymbol = function() { return this }
	...
	while (match = nontermRe.exec(text)) {
	    var l = match[1], nontermId = match[2], s = "", r = match[3]
	    if ((nontermId in letter.grammar.nonterm) && !(nontermId in visited)) {
		visited[nontermId] = 1
