...
//		span.appendChild (select);
	...
	while (typeof(n) != 'undefined') {
	    ...
	    if (n.symbol instanceof lw.NontermPostamble
		&& n.parent.child[1].symbol instanceof lw.NontermExpansion
		&& !(n.parent.child[1].symbol.random()))
		break  // don't count postambles of player choices as recursion
	...
	return count[this.symbol.nonterminal.id]
    }
